...
function enrichSpotlights(spotlights, canonical) {
  ...
  return spotlights.map((spotlight, index) => ({
    ...spotlight,
    image: resolveSpotlightBannerImage(spotlight, canonical, index),
  }));
}
      ...
      spotlights: [
        {
          ...
          href: `${base}/products?sort=featured`,
          tone: 'accent',
          image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=1400&q=82&auto=format&fit=crop',
        },
      ],
    },
    'fashion-clothing': {
      ...
      spotlights: [
        {
          ...
          href: `${base}/products`,
          tone: 'dark',
          image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=1400&q=82&auto=format&fit=crop',
        },
      ],
    },
    'restaurant-cafe': {
      ...
      spotlights: [
        {
          ...
          href: `${base}/contact`,
          tone: 'accent',
          image: 'https://images.unsplash.com/photo-1578985545062-55a8154f7274?w=1400&q=82&auto=format&fit=crop',
        },
      ],
    },
  };
