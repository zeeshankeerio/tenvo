...
const FASHION_DEMO_PROMO_BANNERS = {
  boutique: [
    {
      id: 'pret',
      title: 'Ready to wear',
...
export function resolveFashionPromoBanners(settings = {}, products = [], businessCategory, businessDomain) {
  ...
  const demoBanners = FASHION_DEMO_PROMO_BANNERS[variant] || FASHION_DEMO_PROMO_BANNERS.boutique;
  return buildPromoBannersFromCatalog(products, config.promoBanners, demoBanners, {
