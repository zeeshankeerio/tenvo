...
/**
 * Cart drawer — dark item list (brand shell) + light checkout footer.
 * Use RESTAURANT_UI for rows on the dark surface; RESTAURANT_CHECKOUT_UI for the footer.
 */
export const RESTAURANT_CART_DRAWER_UI = {
  shell: `${RESTAURANT_UI.page} border-neutral-800`,
  itemRow: `${RESTAURANT_UI.divider} hover:bg-neutral-900/50`,
  itemName: `${RESTAURANT_UI.heading} text-sm hover:text-neutral-300`,
  itemMeta: RESTAURANT_UI.muted,
  itemPrice: 'text-sm font-bold text-white',
  qtyBorder: 'border-neutral-700',
  qtyButton: 'hover:bg-neutral-800 text-white',
  footer: `border-t ${RESTAURANT_CHECKOUT_UI.divider} bg-white`,
  closeButton:
    '[&>button]:text-neutral-200 [&>button]:opacity-90 [&>button]:hover:bg-neutral-800 [&>button]:hover:opacity-100 [&>button]:ring-offset-neutral-900',
};
