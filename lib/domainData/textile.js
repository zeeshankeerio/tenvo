export const textileDomains = {
    'textile-wholesale': {
        ...
        productFields: ['Article No', 'Design No', 'Fabric Type', 'Kora/Finished', 'Width (Arz)', 'Thaan Length', 'Suit Cutting', 'Sourcing', 'Origin'],
        ...
        fieldConfig: {
            ...
            thaanlength: { label: 'Thaan Length', type: 'number', placeholder: 'Meters per Thaan', required: false, default: 40 },
