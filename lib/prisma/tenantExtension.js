...
const MODELS_EXCLUDED_FROM_TENANT_SCOPE = new Set([
  ...
  'businesses',
  'subscription_plans',
  // invoice_payments: InvoicePaymentService uses raw pool SQL with explicit business_id;
  // auto-scope would not help findUnique paths and is unused for this model today.
  'invoice_payments',
]);
