...
import {
    ...
    getProductBatchesForPosAction,
} from '@/lib/actions/standard/posVoid';
import {
...
export const posAPI = {
    ...
    async voidTransaction(data) { return await voidPosTransactionAction(data); },
    async getSettings(businessId) { return await getPosSettingsAction(businessId); },
    async updateSettings(businessId, patch) { return await updatePosSettingsAction(businessId, patch); },
    async getProductBatches(businessId, productId) {
        return await getProductBatchesForPosAction(businessId, productId);
    },
