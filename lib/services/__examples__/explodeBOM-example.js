...
async function basicBOMExplosion() {
    ...
    try {
        ...
        if (result.insufficientMaterials > 0) {
            console.log(`\n⚠️  Warning: ${result.insufficientMaterials} material(s) have insufficient stock`);
        }
...
async function checkMaterialsBeforeProduction() {
    ...
    try {
        ...
        if (explosion.canProduce) {
            console.log('✅ All materials available. Safe to start production.');
            ...
            console.log('❌ Cannot start production. Insufficient materials:');
...
async function generatePurchaseList() {
    ...
    try {
        ...
        if (insufficientMaterials.length === 0) {
            console.log('✅ All materials in stock. No purchases needed.');
        } else {
