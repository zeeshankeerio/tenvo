...
async function checkAuth(businessId, client = null, permission = 'crm.manage_loyalty', feature = 'loyalty_programs') {
...
export async function createLoyaltyProgramAction(data) {
    try {
        await checkAuth(data.businessId, null, 'crm.manage_loyalty', 'loyalty_programs');
...
export async function getLoyaltyProgramsAction(businessId) {
    ...
    try {
        await checkAuth(businessId, client, 'crm.manage_loyalty', 'loyalty_programs');
