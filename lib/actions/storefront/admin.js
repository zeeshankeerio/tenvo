...
export async function updateBusinessSettings(businessId, settings) {
  ...
  try {
    ...
    const dealershipRaw = dealership;
    const autoPartsRaw = autoParts;
    const restaurantRaw = restaurant;
    const pharmacyRaw = pharmacy;
    const furnitureRaw = furniture;
    const fitnessRaw = fitness;
    const fashionRaw = fashion;
    ...
    if (dealershipRaw && typeof dealershipRaw === 'object') {
      ...
      newStoreSettings.storefront = {
        ...
        dealership: {
          ...
          heroSlides: Array.isArray(dealershipRaw.heroSlides)
            ? dealershipRaw.heroSlides
            : prev.heroSlides,
    ...
    if (restaurantRaw && typeof restaurantRaw === 'object') {
      ...
      newStoreSettings.storefront = {
        ...
        restaurant: {
          ...prev,
          ...restaurantRaw,
          heroSlides: Array.isArray(restaurantRaw.heroSlides) ? restaurantRaw.heroSlides : prev.heroSlides,
    ...
    if (pharmacyRaw && typeof pharmacyRaw === 'object') {
      ...
      newStoreSettings.storefront = {
        ...
        pharmacy: {
          ...prev,
          ...pharmacyRaw,
          heroSlides: Array.isArray(pharmacyRaw.heroSlides) ? pharmacyRaw.heroSlides : prev.heroSlides,
    ...
    if (furnitureRaw && typeof furnitureRaw === 'object') {
      ...
      newStoreSettings.storefront = {
        ...
        furniture: {
          ...prev,
          ...furnitureRaw,
          heroSlides: Array.isArray(furnitureRaw.heroSlides) ? furnitureRaw.heroSlides : prev.heroSlides,
    ...
    if (fitnessRaw && typeof fitnessRaw === 'object') {
      ...
      newStoreSettings.storefront = {
        ...
        fitness: {
          ...prev,
          ...fitnessRaw,
          heroSlides: Array.isArray(fitnessRaw.heroSlides) ? fitnessRaw.heroSlides : prev.heroSlides,
