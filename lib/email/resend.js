...
function AbandonedCartEmail({ cart, business }) {
  return React.createElement('div', null,
    React.createElement('h1', null, "Don't forget about your cart!"),
    React.createElement('p', null, `You have ${cart.items.length} items waiting in your cart at ${business.name}.`)
  );
}
