...
export function usePermissions() {
    ...
    const helpers = useMemo(() => ({
         ...
         */
        canNav: (navKey) => getNavItemAccess(navKey, effectiveRole, planTier, businessSettings, platformOverrides),
        ...
        role: effectiveRole,
        planTier,
    }), [effectiveRole, planTier, businessSettings, platformOverrides]);
